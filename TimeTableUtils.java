...
public class TimeTableUtils {
    ...
    public static int getHour(String t) { return Integer.parseInt(t.split(":")[0]); }
    public static int getMinute(String t) { String[] p = t.split(":"); return (p.length>1)?Integer.parseInt(p[1]):0; }
    public static int getMinutesFromTime(String t) { return getHour(t)*60 + getMinute(t); }
